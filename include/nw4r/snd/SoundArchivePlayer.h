...
#include "nw4r/snd/DisposeCallbackManager.h" // detail::DisposeCallback
#include "nw4r/snd/MmlParser.h"
#include "nw4r/snd/NoteOnCallback.h" // This needs to be
#include "nw4r/snd/MmlSeqTrackAllocator.h" // before this
...
#include "nw4r/snd/WsdPlayer.h" // and this needs to be
#include "nw4r/snd/SoundStartable.h" // before this
#include "nw4r/snd/StrmChannel.h" // detail::StrmBufferPool
#include "nw4r/snd/StrmSound.h"
#include "nw4r/snd/Util.h" // Util::Table
...
namespace nw4r { namespace snd
{
	...
	public:
		...
		virtual u32 detail_ConvertLabelStringToSoundId(char const *label)
		{
            ...
            NW4R_ASSERT_PTR_NULL(mSoundArchive, 194);
		...
		void SetSeqUserprocCallback(SeqUserprocCallback *callback, void *callbackArg);
