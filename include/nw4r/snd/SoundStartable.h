...
namespace nw4r { namespace snd
{
	...
	public:
		...
		StartResult PrepareSound(SoundHandle *handle, u32 soundId) {
			return detail_PrepareSound(handle, soundId, NULL);
		}

		StartResult StartSound(SoundHandle *handle, u32 soundId, StartInfo const *startInfo) {
			return detail_StartSound(handle, soundId, startInfo);
		}
	...
	private:
		...
		StartResult detail_HoldSound(SoundHandle *handle, u32 soundId,
		                             StartInfo const *startInfo);
		StartResult detail_PrepareSound(SoundHandle *handle, u32 soundId,
		                              StartInfo const *startInfo);
