...
namespace nw4r { namespace snd { namespace detail
{
	...
	private:
		u8 ReadByte(u8 const **ptr) const { return *(*ptr)++; }
		u16 Read16(u8 const **ptr) const;
		u32 Read24(u8 const **ptr) const;
		s32 ReadVar(u8 const **ptr) const;
		s32 ReadArg(u8 const **ptr, SeqPlayer *player, SeqTrack *track,
